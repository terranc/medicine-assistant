        ...
        <div className="container px-4 md:px-6">
          <div className={`mx-auto flex items-center transition-all duration-300 ${
            ...
            <form onSubmit={handleSubmit} className="flex-1 w-full mb-0">
               {/* 
                 Mobile: Flex-col (2 rows) 
                 Desktop (md): Flex-row (1 row)
               */}
               <div className="flex flex-col md:flex-row gap-2 w-full">
                
                {/* Row 1 (Mobile): Input Field */}
                ...
                {/* Row 2 (Mobile): Switch & Button Wrapper */}
                <div className="flex items-center gap-2 w-full md:w-auto">
                  {/* AI Switch - Fixed Width */}
                  <div className="flex items-center gap-2 px-1 bg-white border border-input rounded-md h-10 hover:bg-slate-50 transition-colors shrink-0">
                    {/* Always show label for clarity now that we have space on mobile row 2 */}
                    <label htmlFor="ai-toggle" className={`text-sm font-medium cursor-pointer select-none pl-2 transition-colors whitespace-nowrap ${useAi ? 'text-primary' : 'text-muted-foreground'}`}>
                      AI 搜索
                    </label>
                    <button
                      id="ai-toggle"
                  ...
                  {/* Search Button - Fills remaining width on mobile */}
                  <button
                    type="submit"
                    disabled={isSearching}
                    className="flex-1 md:flex-none md:w-auto inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 whitespace-nowrap"
                  >
                    {isSearching ? '...' : '搜索'}
                  </button>
                </div>
